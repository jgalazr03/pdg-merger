 ...
 *
 * Se renderiza SOLO en cliente (la carga en page.tsx usa dynamic ssr:false):
 * algunos primitivos Radix que usa (Progress, etc.) rompen el "collect page
 * data" del build de Next 13.5 al evaluarse en servidor.
 */
...
export default function EstiloShowcase() {
