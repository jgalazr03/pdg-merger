...
export interface ToolDef {
  ...
  description: string;
  /**
   * Sinónimos y vocabulario del usuario para el buscador único (`searchTools`,
   * lib/search-tools.ts): verbos coloquiales ("juntar", "rotar"), tareas
   * ("quitar páginas") y los nombres en inglés que usa iLovePDF ("merge",
   * "unlock"). No se muestran en la interfaz.
   */
  keywords: string[];
  Icon: LucideIcon;
  accent: ToolAccent;
